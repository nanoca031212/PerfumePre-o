...
// {{name}} é substituído pelo nome do cliente no momento do envio.
export const DEFAULT_EMAIL_MESSAGES: Partial<Record<OrderStatus, EmailMessageTemplate>> = {
  order_confirmed: {
  ...
  in_preparation: {
    ...
    body: 'Your order is currently being processed and prepared for dispatch.\n\nDue to high demand, your tracking code will be sent within 3 to 5 days.',
  },
  processing_update: {
    subject: 'Processing update',
    body: 'Your order is in the final stage of preparation and is leaving our distribution centre.\n\nYou will receive your tracking code shortly.',
  },
  Dispatched: {
...
export function renderEmailBody(body: string, name: string): string {
