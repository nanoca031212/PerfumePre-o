...
export const EMAIL_AUTOMATION_STEPS: EmailAutomationStep[] = [
  {
    ...
    description:
      "Confirma para o cliente que o pedido foi recebido com sucesso.",
    icon: CheckCircle2,
  },
  {
    id: "in-preparation",
  ...
  },
  {
    ...
    subtitle: "Processing update",
    description:
      "Atualiza o cliente informando que o pedido foi processado e despachado.",
    icon: PackageCheck,
  },
  {
    id: "Dispatched",
